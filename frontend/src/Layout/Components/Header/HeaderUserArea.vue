      ...
      <div class="widget-content p-0">
        <div class="widget-content-wrapper">
            ...
            <b-dropdown toggle-class="p-0 mr-2" menu-class="dropdown-menu-lg" variant="link" no-caret right>
              <span slot="button-content">
                <div class="icon-wrapper icon-wrapper-alt rounded-circle">
                  <img width="42" class="rounded-circle" :src="profile.user_pic" alt />
                </div>
              </span>
                  ...
                  <div class="menu-header-content text-left">
                    <div class="widget-content p-0">
                      <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-left">
                          <div class="widget-heading">{{profile.first_name}} {{profile.last_name}}</div>
                          <div class="widget-subheading opacity-8">{{profile.about}}</div>
                        </div>
                        <div class="widget-content-right mr-2">
                          <button class="btn-pill btn-shadow btn-shine btn btn-focus" v-on:click="logOut">Logout</button>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="widget-content-left ml-3 header-user-info">
            <div class="widget-heading">{{profile.first_name}} {{ profile.last_name }}</div>
            <div class="widget-subheading">Статус {{ preset.getName(preset.user.role, profile.role ) }}</div> <!--preset.getName(preset.user.role, profile.role )-->
          </div>
...
export default {
  ...
  beforeCreate() {
    ...
    //console.log("isAuthenticated", this.$store.state.authUser.isAuthenticated)
